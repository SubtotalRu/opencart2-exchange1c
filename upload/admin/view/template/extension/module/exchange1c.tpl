						...
						<fieldset>
							...
							<div class="form-group">
								<ul>
									...
									<li>Добавлена опция в настройках заказа "Статус отмененных", этот статус будет установлен у заказов отмененных в 1С:Предприятие УНФ 1.6, для других не тестировалось, присылайте Ваши файлы orders.xml внесу поправки</li>
							...
							<div class="form-group">
								<ul>
									...
									<li>Поправлена ошибка при выполнении ручной генерации SEO (не проверялось)</li>
							...
							<div class="form-group">
								<ul>
									<li>В процессе доработка если контрагент зарегистрирован как Организация и в 1С он переименован...</li>
								</ul>
							</div>
							...
							<div class="form-group">
								<ul>
									...
									<li>2018-10-15. Исправлена ошибка при авторизации 1С с модулем при наличии REMOTE_USER но при отсутствии REDIRECT_REMOTE_USER</li>
								</ul>
							</div>
